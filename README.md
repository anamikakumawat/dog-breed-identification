...
1. **Food Vision**
   ...
   - GitHub: [Food Vision](https://github.com/anamikakumawat/dog-breed-identification/tree/main/Food-Vision)
...
3. **LipNet: Lipreading using Deep Learning with Conv3D and Bi-LSTM**
   ...
   - GitHub: [LipNet](https://github.com/anamikakumawat/dog-breed-identification/tree/main/LipNet)
